...
namespace Database19
{
    public partial class Form1 : Form
    {
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            conn.Open();
            DataTable dt = new DataTable();
            OleDbDataAdapter adtr = new OleDbDataAdapter("Select * From Tablo1 Where adi like'%" + textBox7.Text + "%'", conn);
            adtr.Fill(dt);
            dataGridView1.DataSource = dt;
            conn.Close();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                vizeort = (Convert.ToDouble(textBox5.Text) + Convert.ToDouble(textBox6.Text)) / 2;
                ...
                conn2.Open();
                string query = "Insert Into Tablo2([adi],[soyadi],[numara],[vize1],[vize2],[vizeort],[final],[basari])Values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','"
                + textBox4.Text + "','" + textBox5.Text + "','" + vizeort + "','" + textBox6.Text + "','" + basari + "')";
                OleDbCommand cmd3 = new OleDbCommand(query, conn2);
                MessageBox.Show(cmd3.ExecuteNonQuery() + "kayit  eklendi");
                conn2.Close();
                listele();
                listele2();
                textBox1.Clear();
