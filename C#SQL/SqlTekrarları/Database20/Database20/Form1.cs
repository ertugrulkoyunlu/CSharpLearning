...
namespace Database20
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            cmd.Connection = conn;
            cmd.CommandText = "Insert Into Tablo1(adi,soyadi,numara,vize1,vize2,final)Values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text +
            "','" + textBox6.Text + "')";
        ...
        {
            //delete according to number
            conn.Open();
            cmd.Connection = conn;
            cmd.CommandText = "Delete  From Tablo1 Where numara=" + textBox3.Text;
            MessageBox.Show(cmd.ExecuteNonQuery() + "kayit/kayitlar silindi");
            conn.Close();
            listele();
        }
        ...
        {
            // find records according to name // select ogesinde data adapter kullaniliyor ve bunun icin ayri bir data table olustulup secimler orda gosteriliyor veri tabaninda deil ekranda gosterliyor
            //Delete ve insert into cmd 
            conn.Open();
            DataTable dt = new DataTable();
            OleDbDataAdapter adtr = new OleDbDataAdapter("Select * From Tablo1 Where adi ='" + textBox1.Text + "'", conn);
            adtr.Fill(dt);
        ...
        {
            //enter new name after number for change the records
            conn.Open();
            DataTable dt = new DataTable();
            OleDbDataAdapter adtr = new OleDbDataAdapter("Update  Tablo1 Set adi ='" + textBox1.Text + "'" + "Where numara=" + textBox3.Text, conn);
            MessageBox.Show(adtr.Fill(dt) + "kayit deigistirildi");
            dataGridView1.DataSource = dt;
            adtr.Dispose();
            conn.Close();
            listele();
        ...
        {
            //calculate show the table2 and write the  second database
            ...
            while (dr.Read())
            {
                ...
                MessageBox.Show(cmd3.ExecuteNonQuery() + "kayit/kayitlar veri tabanina eklendi");
                conn2.Close();
                listele();
                listele2();
                textBox1.Clear();
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            conn.Open();
            DataTable dt = new DataTable();
            OleDbDataAdapter adtr3= new OleDbDataAdapter("Select *From Tablo1 Where adi like '%"+textBox7.Text +"%'",conn);
            adtr3.Fill(dt);
            dataGridView1.DataSource=dt;
            conn.Close();
        }
