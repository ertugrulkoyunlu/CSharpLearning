...
namespace Database23
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbDataAdapter adtr = new OleDbDataAdapter("Select * From Tablo1 where aboneno=" + textBox1.Text, conn);
            adtr.Fill(dt);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            conn.Open();
            DataTable dt = new DataTable();
            OleDbDataAdapter adtr = new OleDbDataAdapter("Update Tablo1 Set adresi='" + textBox2.Text + "'" + "Where aboneno= " + textBox1.Text, conn);
            adtr.Fill(dt);
            dataGridView1.DataSource = dt;
            adtr.Dispose();
            conn.Close();
