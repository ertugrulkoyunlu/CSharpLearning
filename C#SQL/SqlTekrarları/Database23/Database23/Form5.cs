    ...
    public partial class Form5 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                string query = "Insert Into Tablo1([adi],[soyadi],[adresi],[sayacno],[ilkendex],[sonendex],[aboneno],[harcama],[meblag])Values('" + a1 + "','" + a2 + "','" + a3 + "','"
                + a4 + "','" + a5 + "','" + a6 + "','" + a7 + "','" + a8 + "','" + a9 + "')";
                OleDbCommand cmd1 = new OleDbCommand(query, conn3);
