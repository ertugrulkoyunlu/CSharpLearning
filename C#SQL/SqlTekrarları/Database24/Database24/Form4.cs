...
namespace Database24
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbDataAdapter adtr2 = new OleDbDataAdapter("Select * From Tablo1 where aboneno=" + textBox1.Text, conn);
            adtr2.Fill(dt);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            conn.Open();
            DataTable dt = new DataTable();
            OleDbDataAdapter adtr2 = new OleDbDataAdapter("Update Tablo1 Set adresi='" + textBox2.Text +"'"+ "where aboneno=" + textBox1.Text, conn);
            adtr2.Fill(dt);
            dataGridView1.DataSource = dt;
            adtr2.Dispose();
            conn.Close();
