...
namespace SqlKayitSilGoruntule
{
    public partial class Form1 : Form
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("Insert Into Kitaplar(id,kitapad,yazar,yayinevi,sayfa)Values('" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox4.Text.ToString() + "','" + textBox5.Text.ToString() + "')", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            goruntule();
            textBox1.Clear();
