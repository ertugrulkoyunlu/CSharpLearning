...
namespace SqlVeriTabani
{
    public partial class Form1 : Form
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("Insert Into kitaplar (id,kitapad,yazar,yayinevi,sayfa)Values('" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "','"
            + textBox3.Text.ToString() + "','" + textBox4.Text.ToString() + "','" + textBox5.Text.ToString() + "')", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            goruntule();
            textBox1.Clear();
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("Update kitaplar set id ='" + textBox1.Text.ToString() + "',kitapad='" + textBox2.Text.ToString() + "',yazar ='"+ textBox3.Text.ToString() +"',yayinevi= '"+ textBox4.Text.ToString()+ "',sayfa='"+ textBox5.Text.ToString()+ "'where id= " +id +  "", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            goruntule();
        }
