...
namespace SqlVeriTabani3
{
    public partial class Form1 : Form
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand(" Insert Into kitaplar (id,kitapad,yazar,yayinevi,sayfa) Values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "')", conn);
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                ListViewItem add = new ListViewItem();
